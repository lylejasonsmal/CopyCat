...
describe("DatePolicyPage", ()=>{
  ...
  it("SHOULD render data policy heading", () => {
    ...
    expect(dataPolicyHeading.text()).toBe("Data Policy")
  });

  it("SHOULD render data policy message", () => {
    const dataPolicyMessage = sut.find("#data-policy-message");
    expect(dataPolicyMessage.text()).toBe("Our Data Policy Aims To Ensure That Your Data Is Used Within Reasonable Boundaries And To Provided The Best Possible Service.")
  });
})
